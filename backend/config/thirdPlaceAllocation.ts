// AUTO-GERADO a partir do Anexo C do Regulamento da Copa do Mundo FIFA 2026.
// Não editar à mão. As 495 combinações (C(12,8)) determinam qual 3º colocado
// enfrenta cada vencedor de grupo na Rodada de 32, conforme a tabela oficial da FIFA.
//
// Chave: as 8 letras dos grupos cujos 3os colocados se classificaram, em ordem alfabética.
// Valor: { grupo do vencedor -> letra do grupo do 3º colocado adversário }.
// Os vencedores que enfrentam 3os colocados são: 1A, 1B, 1D, 1E, 1G, 1I, 1K, 1L.

export type ThirdAllocation = Record<string, string>;

export const THIRD_PLACE_ALLOCATION: Record<string, ThirdAllocation> = {
...
/**
 * Dado o conjunto dos 8 grupos cujos 3os colocados se classificaram,
 * retorna o mapa { grupo do vencedor -> grupo do 3º adversário } do Anexo C.
 * Retorna null se a combinação não for válida (ex.: != 8 grupos).
 */
export function allocateThirds(qualifiedThirdGroups: string[]): ThirdAllocation | null {
